...
public interface LojaController {
	 ...
	 *            - Login do usuário.
	 * @param quantia
	 *            - Quantia a ser adicionada à conta.
	 ...
	 * @param jogabilidadesStr
	 *            - String com a jogabilidade do jogo.
	 * @param preco
	 *            - preço do jogo.
	 * @param tipo
	 *            - tipo do jogo.
	 * @throws JogoInvalidoException
	 *             Caso o jogo seja inválido.
	 * @throws SaldoInsuficienteException
	 *             Caso o saldo do usuário seja insuficiente
	 * @throws UsuarioInvalidoException
	 *             Caso o usuário seja inválido.
	 */
	void vendeJogo(final String login, final String nomeJogo,
	 ...
	 *            - login do usuário;
	 * @throws UsuarioInvalidoException
	 *             Caso o login do usuário seja inválido
	 * @throws UsuarioInaptoException
	 *             caso o usuário seja inapto a upgrade.
	 */
	void upgrade(final String login) throws UsuarioInvalidoException,
			UsuarioInaptoException;

	/**
	 * Registra que o {@link Usuario} que possui {@code login} como login jogou
	 * determinado jogo.
	 *
	 * @param login
	 *            - login do usuario.
	 ...
	 *            - jogo que foi jogado.
	 * @param score
	 *            - Valor do score do usuario.
	 * @param zerou
	 *            - Indica se o usuário zerou o jogo.
	 * @throws JogoInvalidoException
	 *             - Caso o jogo seja inválido.
	 * @throws UsuarioInvalidoException
	 *             - Caso o usuário seja inválido.
	 */
	void registraJogada(final String nomeJogo, final String login,
			final int score, final boolean zerou) throws JogoInvalidoException,
